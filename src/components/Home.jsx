...
const Home = () => {
    ...
    useEffect(() => {
        const fetchMovies = async () => {
            try {
                const trendingResponse = await axios.get('https://pop-corn-pal.onrender.com/api/movies/trending');
                setTrendingMovies(trendingResponse.data);

                const popularResponse = await axios.get('https://pop-corn-pal.onrender.com/api/movies/popular');
                setPopularMovies(popularResponse.data);

                const topRatedResponse = await axios.get('https://pop-corn-pal.onrender.com/api/movies/top-rated');
                setTopRatedMovies(topRatedResponse.data);

                const upcomingResponse = await axios.get('https://pop-corn-pal.onrender.com/api/movies/upcoming');
                setUpcomingMovies(upcomingResponse.data);

                const nowPlayingResponse = await axios.get('https://pop-corn-pal.onrender.com/api/movies/now-playing');
